...
$configs->env->development->auth->setURLs('/sistema/lista-produtos', '/sistema/lista-produtos' );
$configs->env->development->mail->setFrom([
			'from' => 'Guilherme',
			'from_mail' => 'guilhermecaetanowp@outlook.com'
		]);
$configs->title = 'AGP Performace';
